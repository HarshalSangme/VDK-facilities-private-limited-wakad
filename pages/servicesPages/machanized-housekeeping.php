...
<body>
        ...
        <section>
                ...
                <div class="row service1-container">
                        ...
                        <div class="col">
                                <h2 class="heading-service"> Machanized Housekeeping </h2>

                                <div class="span-line"></div>

                                <p class="service1-para">
                                    Mechanized Cleaning involves cleaning & maintenance of residential as well as commercial complexes
                                    such as malls, Hospitals, IT Parks, industrial premises, educational institutions, and
                                    other corporate.
                                    The main objective of companies offering mechanized housekeeping services
                                    is to create a clean and hygienic environment.  
                                <br> <br> 
                                    Mechanized housekeeping services include
                                    everything from dusting and moping to cleaning of floors, window panels, glasses, floor scrubbing, floor polishing, vacuum cleaning, machine cleaning
                                    and maintenance, pest control and
  ...
  <section>
     ...
     <div class="section2-container">
        ...
        <h2 class="section2-h1-heading">Machanized Housekeeping by <span class="text-danger">VDK</span></h2>
