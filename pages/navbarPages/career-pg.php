...
<nav class="navbar fixed-top navbar-expand-lg">
    ...
    <section>
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner" style="max-height:350px !important;">
              <div class="carousel-item active" data-aos="flip-right" data-aos-duration="2000">
    ...
    <section>
    <div class="main container text-center py-3">

        <h1 class="career-heading" data-aos="fade-up" data-aos-duration="2000">Career Form</h1>

        <form class="php-email-form" action="../../forms/careerFormLogic.php" method="post" enctype="multipart/form-data" data-aos="fade-down" data-aos-duration="2000">
        <div class="row">
        ...
        <div class="row">
            ...
            <input class="form-control" type="tel" name="phoneno" placeholder="Enter your contact no"> 
            </div>
            <div class="col-md-6 form-group mt-3">
        ...
        <div class="row">
            <div class="col-md-6 form-group mt-3">
            <input class="form-control" type="text" name="department" placeholder="Department name ex:- Road Development">
            </div>
            <div class="col-md-6 form-group mt-3">
            <input class="form-control" type="text" name="jobtitle" placeholder="Role ex:- Manager, Cleaner etc">
            </div>
        </div>
            <input class="form-control mt-3" type="text" name="joblocation" placeholder="Job Location:- Pune, Raigad etc"> <br>
            <input class="form-control" type="file" name="file" placeholder="Upload Resume"> <br>
            <textarea class="form-control" type="text" name="message" placeholder="Message"></textarea> <br>
